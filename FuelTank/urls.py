...
from FuelTankApp import views

urlpatterns = [
    path('admin/', admin.site.urls),
    path('', views.HomePage, name='HomePage'),
    path('leaktestfunc', views.leaktestfunc, name='leaktestfunc'),
    path('Leaktestform', views.Leaktestform, name='Leaktestform'),
